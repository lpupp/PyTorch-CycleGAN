...
srun python ${GIT_PATH}/training.py --dataroot ${DATA_BASE_PATH}/${RUN_DOMAIN}/${RUN_NAME} --cuda --n_cpu 8 --n_epochs 300 --batch_size ${BS} --lr ${LR} --size ${IMG_SIZE} --output_dir ${OUTPUT_DIR} >> ${OUTPUT_DIR}/${RUN_NAME}_${IMG_SIZE}_${BS}_${LR}.txt
